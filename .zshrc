...
alias Rdd='Rscript -e "devtools::document()"'
alias Rdt='Rscript -e "devtools::test()"'
alias Rdc='Rscript -e "devtools::check()"'
alias Rdb='Rscript -e "devtools::build()"'
alias Rdi='Rscript -e "devtools::install(build_vignettes = TRUE)"'
# Update packages
